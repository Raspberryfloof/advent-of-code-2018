    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                int highestSum = -1, highestMinute = -1, minuteIndex = -1;
                ...
                {
                    if (guardData.Value.Sum() > highestSum)
                    {
                        highestSum = guardData.Value.Sum();
                ...
                for (int m = 0; m < 60; m++)
                {
                    if (history[currentGuard][m] > highestMinute)
                    {
                        minuteIndex = m;
                        highestMinute = history[currentGuard][m];
                    }
                }
